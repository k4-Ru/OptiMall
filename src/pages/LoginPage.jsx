            ...
            <div className="grid content-between gap-8 px-12 py-12">
              <div>
                ...
                <h1 className="max-w-[12ch] text-[clamp(2.4rem,4vw,3.8rem)] font-extrabold leading-[1.05] tracking-tight text-balance">
                  Welcome back to your shopping workspace
                </h1>
                <p className="mt-5 max-w-[52ch] text-base leading-relaxed text-[#475569]">
                  Continue with personalized recommendations, budget-aware bundles, and faster checkout from one account.
                </p>
              </div>

              <div className="grid gap-3">
                <div className="rounded-2xl border border-[#1a2a54]/16 bg-white/82 px-5 py-4 shadow-[0_14px_32px_rgba(26,42,84,0.11)]">
                  <p className="text-sm font-semibold text-[#0f172a]">Personalized recommendations</p>
                  <p className="mt-1 text-sm text-[#475569]">Smart product suggestions based on your activity.</p>
                </div>
                <div className="rounded-2xl border border-[#ff6b00]/30 bg-white/86 px-5 py-4 shadow-[0_14px_32px_rgba(255,107,0,0.16)]">
                  <p className="text-sm font-semibold text-[#0f172a]">Budget-aligned bundles</p>
                  <p className="mt-1 text-sm text-[#475569]">See optimized bundle tiers and add them in one step.</p>
                </div>
                <div className="rounded-2xl border border-[#1a2a54]/16 bg-white/82 px-5 py-4 shadow-[0_14px_32px_rgba(26,42,84,0.11)]">
                  <p className="text-sm font-semibold text-[#0f172a]">Persistent cart and history</p>
                  <p className="mt-1 text-sm text-[#475569]">Your cart and order context stay synced across sessions.</p>
                </div>
              </div>
            </div>
